...
public class WordStatInputTest {
    ...
    protected void test() {
        ...
        randomTest(4, 10, 10, 3, Randomized.GREEK, WordStatChecker.SIMPLE_DELIMITERS);
        randomTest(4, 10, 10, 3, WordStatChecker.DASH, WordStatChecker.SIMPLE_DELIMITERS);
        ...
        randomTest(10, 10000, 10, 10, WordStatChecker.ALL, WordStatChecker.ADVANCED_DELIMITERS);
        randomTest(10, 1, 10, 10, WordStatChecker.ALL, WordStatChecker.ADVANCED_DELIMITERS);
        randomTest(10, 1000, 100, 100, WordStatChecker.ALL, WordStatChecker.ADVANCED_DELIMITERS);
        randomTest(4, 1000, 10, 3000, WordStatChecker.ALL, WordStatChecker.ADVANCED_DELIMITERS);
        randomTest(4, 1000, 3000, 10, WordStatChecker.ALL, WordStatChecker.ADVANCED_DELIMITERS);
    }
